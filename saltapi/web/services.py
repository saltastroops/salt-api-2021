...
def finding_chart_service(connection: Connection) -> FindingChartService:
    """Return a finding chart service instance."""
    finding_chart_repository = FindingChartRepository(connection)
    return FindingChartService(finding_chart_repository)
