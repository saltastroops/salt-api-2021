...
@pytest.mark.parametrize(
    ...
    [
        ...
        "2020-1", "2020-1", 32, "many"],
        [find_username("TAC Chair", partner_code="RU"), "2021-1", "2021-1", 7, "2018-1-SCI-012, 2018-1-SCI-041, 2021-1-MLT-007, 2021-1-SCI-012, 2021-1-SCI-015, 2021-1-SCI-028, 2021-1-SCI-031"],
        [find_username("TAC Member", partner_code="UW"), "2021-1", "2021-1", 8, "2018-2-LSP-001, 2018-2-MLT-005, 2020-1-MLT-005, 2020-1-MLT-009, 2020-2-MLT-009, 2021-1-SCI-016, 2021-1-SCI-023, 2021-1-SCI-025"],
        [find_username("Principal Investigator", proposal_code="2014-2-SCI-078"), "2020-2", "2020-2", 0, ""],
        [find_username("Principal Investigator", proposal_code="2018-2-LSP-001"), "2017-2", "2021-1", 35, "many"],
        [find_username("SALT Astronomer"), "2020-2", "2020-2", 81, "many"],
        [find_username("Administrator"), "2018-2", "2018-2", 79, "many"],
        [find_username("Principal Investigator", proposal_code="2014-2-SCI-078"), "2018-2", "2019-1", 7, "many"],
...
def test_should_return_correct_list_of_proposals_for_get_proposals_for_authenticated_users(
   username: str, from_semester: str, to_semester: str, proposal_count: int, proposal_codes: str, client: TestClient
    ...
    authenticate(username, client)
    response = client.get(PROPOSALS_URL, params={"from": from_semester, "to": to_semester})
    ...
    if proposal_codes not in ("", "many"):
        assert set(p["proposal_code"] for p in proposals) == set(proposal_codes.split(", "))
